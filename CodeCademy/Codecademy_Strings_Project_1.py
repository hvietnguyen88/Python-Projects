...
#-------------------------------------------------------------
# TASK 1: Break up `daily_sales` in easy to understand lists `customers`, `sales`, and `thread_sold`.
...
#-------------------------------------------------------------# Replace all ';,;' with '|' ub daily_sales
daily_sales_replaced = daily_sales.replace(';,;', '|')

# Split daily_sales_replaced to a new list daily_transactions
...
# Clear whitespace of each data item of daily_transactions_split
transactions_clean = []
for transaction in daily_transactions_split:
  new_transaction = []
  for item in transaction:
    new_transaction.append(item.strip())
...
#-------------------------------------------------------------
# TASK 2: Determine the total value of the days sales.
...
#-------------------------------------------------------------
# TASK 3: How much thread of any specific color was sold?
...
#-------------------------------------------------------------# Split thread_sold into a list of individual colors
thread_sold_split = []
...
colors = ['red', 'yellow', 'green', 'white', 'black', 'blue', 'purple']
for color in colors:
  print(str(color_count(color)) + " threads of {color} were sold today!".format(color=color))